 ...
 */
public class PagarConTransferencia implements Command<Void> {
	
	public String dni;
	public String nombreCompeticion;
	public PagarConTransferencia(String dni, String nombreCompeticion) {
		this.dni = dni;
	...
	public Void execute() throws BusinessException {
		...
		if(ir.estado.toUpperCase().equals("INSCRITO") || ir.estado.toUpperCase().equals("PENDIENTE DE PAGO")) {
			...
			throw new BusinessException("Esta inscripción ha sido anulada por lo que no se puede pagar");
		}
		else if(ir.estado.equals("NO PAGADO")) {
			ig.pagarInscripcionTransferencia(dni, idCompeticion);
		}	
		return null;
//		
	}
