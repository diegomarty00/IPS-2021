...
public class EstadoInscripcionVentana extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EstadoInscripcionVentana frame = new EstadoInscripcionVentana();
	...
	private JTable getTable() {
		String names[] = {"DNI","Nombre","Genero","Nacimiento","Categoria","Fecha Inscripcion","Estado Inscripcion"};
